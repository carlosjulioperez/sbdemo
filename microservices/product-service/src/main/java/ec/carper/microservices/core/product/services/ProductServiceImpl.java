package ec.carper.microservices.core.product.services;
...
public class ProductServiceImpl implements ProductService{
    ...
    public Product getProduct(int productId) {
        ...
        return new Product(productId, "nombre-" + productId, "descripcion-" + productId, serviceUtil.getServiceAddress());
    }
